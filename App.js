...
import { Camera } from 'expo-camera'; // Importe o componente Camera do Expo
    ...
    setShowCamera(false);
      ...
      return (
        <View style={styles.container}>
          {showCamera ? ( // Se showCamera for true, renderize a câmera
            <CameraScreen navigation={navigation} handleCloseCamera={handleCloseCamera} />
          ) : (
            <>
              {/* Se showCamera for false, renderize o conteúdo normal do aplicativo */}
              <Image
